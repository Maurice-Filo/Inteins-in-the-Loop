...
switch PlantChoice
    ...
    case 'Birth-Death'
        ...
        Figure1_Name = 'ModelReduction_TetR_BD.pdf';
        % Swept Parameter
    ...
    case 'Gene Expression'
        ...
        Figure1_Name = 'ModelReduction_TetR_GeneExp.pdf';
        % Swept Parameter
    ...
    case 'Six Node'
        ...
        Figure1_Name = 'ModelReduction_TetR_SixNode.pdf';
        % Swept Parameter
...
[Parameters_Controller, S_Controller, Prop_Controller] = Design_TetRController();
    ...
    Parameters_Controller.Parameters_Actuation.k_prime = 0.05;
