function [u_P, u_N, z_tilde] = ReducedControlAction_TetRController(~, z_p, ~, z_0, Parameters)
%% Extract Parameters
kappa_1 = Parameters.kappa(1);
kappa_2 = Parameters.kappa(2);
kappa_3 = Parameters.kappa(3);
k = Parameters.Parameters_Actuation.k;
k_prime = Parameters.Parameters_Actuation.k_prime;
...
u_P = (k*z_tilde_2 + k_prime*z_tilde_3) / (1 + z_tilde_1/kappa_u);  
u_N = 0;
end