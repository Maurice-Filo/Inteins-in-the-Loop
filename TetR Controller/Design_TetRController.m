function [Parameters_Controller, S, Prop] = Design_TetRController()
...
Parameters_Actuation.k_prime = 0.01;
Parameters_Actuation.kappa_u = 1;
h_P = @(x_L, z, ActuationParameters) ((ActuationParameters.k * z(5) + ActuationParameters.k_prime * z(6)) / (1 + z(4)/ActuationParameters.kappa_u));
