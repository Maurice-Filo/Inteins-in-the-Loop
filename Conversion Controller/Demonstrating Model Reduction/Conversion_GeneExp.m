...
switch PlantChoice
    ...
    case 'Birth-Death'
        ...
        Figure1_Name = 'ModelReduction_Conversion_BD.pdf';
        % Swept Parameter
    ...
    case 'Gene Expression'
        ...
        Figure1_Name = 'ModelReduction_Conversion_GeneExp.pdf';
        % Swept Parameter
    ...
    case 'Six Node'
        ...
        Figure1_Name = 'ModelReduction_Conversion_SixNode.pdf';
        % Swept Parameter
...
%% Select Controller
[Parameters_Controller, S_Controller, Prop_Controller] = Design_ConversionController();
    epsilon = 0.01;
    Parameters_Controller.mu = [5; 0; 0; 5; 0];
    Parameters_Controller.theta = [0; 0.5; 0; 0; 0.5];
    Parameters_Controller.eta = 10;
    Parameters_Controller.a = [] / epsilon;
    Parameters_Controller.d = [] / epsilon;
    Parameters_Controller.c_1 = [1; 1] / epsilon;
    Parameters_Controller.c_2 = [1; 1] / epsilon;
    Parameters_Controller.delta_0 = 1;
    Parameters_Controller.delta = 0;
    Parameters_Controller.Parameters_Actuation.k = 0.01;
    Parameters_Controller.Parameters_Actuation.gamma = 1;
...
Parameters_ReducedController.ControlAction = @ReducedControlAction_ConversionController;
