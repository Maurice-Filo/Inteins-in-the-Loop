function [Parameters_Controller, S, Prop] = Design_ConversionController()
...
Parameters_Actuation.gamma = 1;
h_P = @(x_L, z, ActuationParameters) (ActuationParameters.k * z(4));
h_N = @(x_L, z, ActuationParameters) (ActuationParameters.gamma * z(5));
