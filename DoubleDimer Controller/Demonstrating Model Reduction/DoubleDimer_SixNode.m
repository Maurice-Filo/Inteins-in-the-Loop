...
switch PlantChoice
    ...
    case 'Birth-Death'
        ...
        Figure1_Name = 'ModelReduction_DoubleDimer_BD.pdf';
        % Swept Parameter
    ...
    case 'Gene Expression'
        ...
        Figure1_Name = 'ModelReduction_DoubleDimer_GeneExp.pdf';
        % Swept Parameter
    ...
    case 'Six Node'
        ...
        Figure1_Name = 'ModelReduction_DoubleDimer_SixNode.pdf';
        % Swept Parameter
...
%% Select Controller
[Parameters_Controller, S_Controller, Prop_Controller] = Design_DoubleDimerController();
    epsilon = 0.01;
    ...
    Parameters_Controller.delta_0 = 2;
    ...
    Parameters_Controller.Parameters_Actuation.kappa_u_prime = 1;
...
Parameters_ReducedController.ControlAction = @ReducedControlAction_DoubleDimerController;
