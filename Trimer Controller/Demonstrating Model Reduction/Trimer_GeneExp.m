...
switch PlantChoice
    ...
    case 'Birth-Death'
        ...
        Figure1_Name = 'ModelReduction_Trimer_BD.pdf';
        % Swept Parameter
    ...
    case 'Gene Expression'
        ...
        Figure1_Name = 'ModelReduction_Trimer_GeneExp.pdf';
        % Swept Parameter
    ...
    case 'Six Node'
        ...
        Figure1_Name = 'ModelReduction_Trimer_SixNode.pdf';
        % Swept Parameter
...
%% Select Controller
[Parameters_Controller, S_Controller, Prop_Controller] = Design_TrimerController();
    epsilon = 0.01;
    ...
    Parameters_Controller.delta_0 = 0.01;
...
Parameters_ReducedController.ControlAction = @ReducedControlAction_TrimerController;
